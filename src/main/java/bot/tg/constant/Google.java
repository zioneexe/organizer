...
public final class Google {
    ...
    public static final String DISCONNECTING_GOOGLE_SUCCESS = "Вітаю, ви успішно від'єднали Google Calendar!";
    public static final String DISCONNECTING_GOOGLE_ERROR = "Лишенько.. Сталася помилка при від'єднанні.";
