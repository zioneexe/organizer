...
public final class Validation {
    ...
    public static final Integer TITLE_ERROR_MAX_LENGTH = 40;
    public static final Integer DESCRIPTION_MAX_LENGTH = 512;
    public static final String TITLE = "✅ Бот Organizer успішно стартанув!";
